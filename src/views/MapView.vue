        ...
        <div class="scrollSection">
            <div class="bg-custom-gray">
                <div class="flex items-center px-4 py-5">
                    <img width="75" src="img/m-mob/ride.png" alt="Carro">
                    <div class="w-full ml-3">
                        <div class="flex items-center justify-between">
                            <div class="text-2xl mb-1">NMob Clássico</div>
                            <div class="text-xl">R$ 8,99</div>
                        </div>
                        <div class="text-gray-500">7 horas</div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="flex items-center px-4 py-5">
                    <img width="75" src="img/m-mob/comfort.png" alt="Carro">
                    <div class="w-full ml-3">
                        <div class="flex items-center justify-between">
                            <div class="text-2xl mb-1">NMob Premium</div>
                            <div class="text-xl">R$ 12,99</div>
                        </div>
                        <div class="text-gray-500">7 horas</div>
                    </div>
                </div>
